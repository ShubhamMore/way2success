export class ExamModel {
    ...
    constructor(_id: string, examTitle: string, outOfMarks: string, passingMarks: string, date: string, branch: string, course: string, batch: string, subject: string, marks: MarksModel[]) {
        this._id = _id;
